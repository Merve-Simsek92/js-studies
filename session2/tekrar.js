...
navbarInstructorLi.addEventListener("mouseover",()=>{
    ...
    navbarInstructorLi.getElementsByClassName.color="green"
    navbarInstructorLi.getElementsByClassName.fontSize="1.7rem"

});

navbarInstructorLi.addEventListener("mouseout",()=>{
    navbarInstructorLi.innerText="Instructors"
    navbarInstructorLi.getElementsByClassName.color="#444444"
    navbarInstructorLi.getElementsByClassName.fontSize="1.7rem"
});

// //  navbarstudentsLi.addEventListener("click",()=>{
// //      let newcolor=makerandomcolor();
// //      navbarstudentsLi.style.background=newcolor});
...
// })
// // last name input value 0 olduğunda span gözükmesin
// 3.ve 4. event listener ekleme sekli

// birtday yakala 
// let birtdayPicker=document.querySelector("[name=birtday]");
